...
| `10-us-application-specifics.md` | US portal questions: work-authorization dropdowns, EEO / voluntary self-ID, salary expectations vs. banned salary-history, references, acknowledgement checkboxes |
