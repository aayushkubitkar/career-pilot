...
\documentclass[11pt,letterpaper,sans]{moderncv} % US Letter — see 05-cv-templates.md "US résumé conventions"
...
% personal data
\name{[First]}{[Last]}
% US résumé: city + state only, never a street address. To list nothing, DELETE
% this whole line -- \address{}{}{} fails with "There's no line here to end".
\address{[City, ST]}{}{}
